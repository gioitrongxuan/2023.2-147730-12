package bpbh.CreateProduct.controller;
...
import bpbh.CreateProduct.model.Product;
import bpbh.CreateProduct.model.ProductList;
...
public class CreateProductController {
    ...
    void btnCreatePressed(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/bpbh/CreateProduct/view/CreateProductPopup.fxml"));
