...
import controller1.bpdhqt.orderoperation.merchandisecontroller.MerchandiseController;
...
public class MerchandiseTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		final String MERCHANDISE_FXML_FILE_PATH = "/view1/bpdhqt/orderoperation/merchandiseview/MerchandiseOverview.fxml";
