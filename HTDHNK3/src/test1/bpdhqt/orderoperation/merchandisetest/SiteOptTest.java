package test1.bpdhqt.orderoperation.merchandisetest;

import java.util.ArrayList;

import controller1.bpdhqt.orderoperation.merchandisecontroller.MerchandiseSiteOptController;
...
public class SiteOptTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		final String MERCHANDISEOPT_FXML_FILE_PATH = "/view1/bpdhqt/orderoperation/merchandiseview/SiteOptionView.fxml";
