package bpbh1.CreateProduct.controller;

import bpbh1.CreateProduct.model.ProductList;
...
import bpbh1.CreateProduct.model.Product;
...
public class CreateProductController {
    ...
    void btnCreatePressed(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/bpbh1/CreateProduct/view/CreateProductPopup.fxml"));
