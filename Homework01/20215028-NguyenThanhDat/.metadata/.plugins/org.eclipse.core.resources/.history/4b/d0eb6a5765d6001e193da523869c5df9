...
public class CalculatorJavaSwingController {
	
	private CalculatorJavaSwingView theView;
	private CalculatorJavaSwingModel theModel;
	
	public CalculatorJavaSwingController(CalculatorJavaSwingView theView, CalculatorJavaSwingModel theModel) {
